...
//     const res = await fetch('http://localhost:5003/media/upload', { method: 'POST', body: formData });
...
//     const url = isEditing ? `http://localhost:5003/journals/${editingEntry._id}` : 'http://localhost:5003/journals';
//     await fetch(url, {
//       method,
